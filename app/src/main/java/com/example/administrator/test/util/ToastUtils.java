...
public class ToastUtils {
    ...
    private static int yOffset    = (int) (64 * MyApplication.getApplication().getResources().getDisplayMetrics().density + 0.5);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) MyApplication.getApplication().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
